...
tf.app.flags.DEFINE_string('word_id_file', 'data/restaurant/word_id_new.txt', 'word-id mapping file')
tf.app.flags.DEFINE_string('aspect_id_file', 'data/restaurant/aspect_id_new.txt', 'word-id mapping file')
